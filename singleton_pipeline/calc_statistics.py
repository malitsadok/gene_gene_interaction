...
# def calc_expected(row,E_missense ,E_lof, p_missense , p_lof ,  n):
#     results = {}
 
#     results["expected_both_missense_singleton_1"] = row["q_missense_2"]*row["q_missense_singleton_1"]*(n**2/E_missense**2)*np.sum(m*p_missense*(m*p_missense-1))
#     results["expected_both_missense_singleton_2"] = row["q_missense_singleton_2"]*row["q_missense_1"]*(n**2/E_missense**2)*np.sum(m*p_missense*(m*p_missense-1))
#     results["expected_both_lof_singleton_1"] = row["q_lof_2"]*row["q_lof_singleton_1"]*(n**2 /E_lof**2)*np.sum(m*p_lof*(m*p_lof-1))
#     results["expected_both_lof_singleton_2"] = row["q_lof_singleton_2"]*row["q_lof_1"]*(n**2 /E_lof**2)*np.sum(m*p_lof*(m*p_lof-1)) 
    
    
#     results["expected_both_missense_lof_singleton_1"] = row["q_missense_singleton_1"] * row["q_lof_2"]*(n**2 /(E_lof*E_missense))*np.sum(m*p_lof*(m*p_missense-1))
#     results["expected_both_missense_lof_singleton_2"] = row["q_missense_1"]*row["q_lof_singleton_2"]*(n**2 /(E_lof*E_missense))*np.sum(m*p_lof*(m*p_missense-1))
#     results["expected_both_lof_missense_singleton_1"] = row["q_lof_singleton_1"]*row["q_missense_2"]*(n**2 /(E_lof*E_missense))*np.sum(m*p_lof*(m*p_missense-1))
#     results["expected_both_lof_missense_singleton_2"] = row["q_lof_1"]*row["q_missense_singleton_2"]*(n**2 /(E_lof*E_missense))*np.sum(m*p_lof*(m*p_missense-1))
...
#     pairs_counts["expected_values"] = pairs_counts.apply(lambda row: calc_expected(row,E_missense ,E_lof , p_missense , p_lof  , total_individuals_number), axis=1)
#     print (datetime.now().time())
...
#     pairs_counts['p-value_missense_singleton_1'] = poisson.cdf(pairs_counts['both_missense_singleton_1'], pairs_counts['expected_both_missense_singleton_1'])
#     pairs_counts['p-value_missense_singleton_2'] = poisson.cdf(pairs_counts['both_missense_singleton_2'], pairs_counts['expected_both_missense_singleton_2'])
#     pairs_counts['p-value_lof_singleton_1'] = poisson.cdf(pairs_counts['both_lof_singleton_1'], pairs_counts['expected_both_lof_singleton_1'])
#     pairs_counts['p-value_lof_singleton_2'] = poisson.cdf(pairs_counts['both_lof_singleton_2'], pairs_counts['expected_both_lof_singleton_2'])
    
    
#     pairs_counts['p-value_missense_lof_singleton_1'] = poisson.cdf(pairs_counts['both_missense_lof_singleton_1'], pairs_counts['expected_both_missense_lof_singleton_1'])
#     pairs_counts['p-value_missense_lof_singleton_2'] = poisson.cdf(pairs_counts['both_missense_lof_singleton_2'], pairs_counts['expected_both_missense_lof_singleton_2'])
   
#     pairs_counts['p-value_lof_missense_singleton_1'] = poisson.cdf(pairs_counts['both_lof_missense_singleton_1'], pairs_counts['expected_both_lof_missense_singleton_1'])
#     pairs_counts['p-value_lof_missense_singleton_2'] = poisson.cdf(pairs_counts['both_lof_missense_singleton_2'], pairs_counts['expected_both_lof_missense_singleton_2'])
#     pairs_counts[['gene_1' , 'gene_2' ,'both_missense_singleton_1' ]]
