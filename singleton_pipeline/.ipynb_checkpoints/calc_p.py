...
def calc_p(folder_input ,folder_output ):
    ...
    print ("m")
    print (m)
    result_df = combined_df.groupby('Individual', as_index=False)[["lof" , "missense" , "lof_or_missense"]].sum()
    print ("result_df.Individual.nunique()")
    print (result_df.Individual.nunique())


    result_df["p_lof"] = result_df["lof"] / m
    result_df["p_missense"] = result_df["missense"] / m
    result_df["p_lof_or_missense"] = result_df["lof_or_missense"] / m
