...
if __name__ == "__main__":
    ...
    # dict = {"missense" : ["gene_1" , "gene_2","missense_1","missense_2" ,"both_missense" ,"expected_both_missense" , "p-value_missense"], 
    #          "lof" : ["gene_1" , "gene_2" ,"lof_1" ,"lof_2","both_lof" ,"expected_both_lof" , "p-value_lof"],
    #          "missense_lof" : ["gene_1" , "gene_2" ,"missense_1" ,"lof_2" ,"both_missense_lof" ,"expected_both_missense_lof" , "p-value_missense_lof"], 
    #          "lof_missense" : ["gene_1" , "gene_2" , "lof_1" ,"missense_2" ,"both_lof_missense" ,"expected_both_lof_missense" , "p-value_lof_missense"] ,
    #          "lof_missense_combined" : ["gene_1" , "gene_2" , "missense_1" , "missense_2", "lof_1" , "lof_2" , "both_lof_missense_combined"  ,   "expected_both_lof_missense_combined" , "p-value_lof_missense_combined" ]  }
    dict = {"lof_missense_combined" : ["gene_1" , "gene_2" , "missense_1" , "missense_2", "lof_1" , "lof_2" , "both_lof_missense_combined"  ,   "expected_both_lof_missense_combined" , "p-value_lof_missense_combined" ]}
    for key in dict :
