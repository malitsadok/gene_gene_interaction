...
csv_file="/sci/home/mali.tsadok/scripts_all_data_pipeline.csv"
...
subfolder_list=( "chr1" "chr2" "chr3" "chr4" "chr5" "chr6" "chr7" "chr8" "chr9" "chr10" \
...
python /sci/labs/orzuk/mali.tsadok/UKB/code/$script "\$chr1" "\$chr2" "$input_dir_full" "$output_dir_full"
