...
bash_script="combine_and_filter_service.sh"
...
echo "Subfolders to process: ${subfolder_list[@]}"
...
subfolder_list=(${subfolder_list[@]})  # Use the determined subfolder list
...
echo "start"
python /sci/labs/orzuk/mali.tsadok/UKB/singleton_code/$script "\$subdir_name" "$input_dir_full" "$output_dir_full"
