...
def process_joined_file(data_path, dict_path,gene_set , join_on, global_uniques=None, global_singletons=None):
    # Load the main data
    ...
    gene_set.update(df["gene"].dropna().unique())
    # Collapse df_two
    ...
    return global_uniques, global_singletons , gene_set
...
def process_all_pairs(root_dir, join_on):
    ...
    for data_path in data_files:
        ...
        try:
            global_uniques, global_singletons , gene_set = process_joined_file(
                data_path, dict_path,gene_set, join_on, global_uniques, global_singletons
            )
