...
def process_all_subfolders(root_dir):
    ...
    df_counts.to_csv("/sci/labs/orzuk/mali.tsadok/UKB/mutation_type_after_filter_1_percent.csv", index=False)


if __name__ == "__main__":
        process_all_subfolders("/sci/labs/orzuk/mali.tsadok/UKB/singleton_1/filter_data/lof")
